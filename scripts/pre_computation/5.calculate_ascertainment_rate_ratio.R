## 29th October 2020
## PRE-COMPUTATION SCRIPT E - calculate ascertainment rate ratio between Wuhan and non-Wuhan cities.

setwd(main_wd)

# read in cumulative cases in Hubei and in all other provinces, as of Feb 29
data_feb29=read.csv("./data/midas/table_getAreaStat_en_2020-02-29.csv")
...
data_mar13=read.csv("./data/midas/table_getAreaStat_en_2020-03-13.csv")
