## 29th October 2020
## SCRIPT 3 - Reads in master table and extracts all of the numbers and predictions cited in the main text
## NOTE: this script produces Table S2
...
############################
## Set the main scenario here to read out results for each analysis
main_scenario <- "Scenario 1"

mt <- read.csv("./data/master_table_1029.csv", stringsAsFactors = FALSE)
